...
public:
  ...
  {
    return static_cast<bool>(_arr);

    char *data() { return _arr.get(); }

    int length() const { return _length; }

    std::string_view asStringView() const { return std::string_view(_arr.get(), _length); }
...
private:
  ...
  public:
    ...
    httpVersionGet() const
    {
      ...
      return TSHttpHdrVersionGet(_msgBuffer, _loc);
    }
  ...
  public:
    ...
    urlLocGet(TSMLoc &urlLoc)
    {
      ...
      return TSHttHdrUrlGet(msgBuffer(), loc(), &urlLoc) == TS_SUCCESS;
    }
    ...
    urlLocSet(TSMLoc &urlLoc)
    {
      ...
      return TSHttHdrUrlSet(msgBuffer(), loc(), urlLoc) == TS_SUCCESS;
    }
  };
  ...
  reasonSet(std::string_view sv)
  {
    ...
    return TSHttpHdrReasonSet(msgBuffer(), loc(), sv.data(), sv.length()) == TS_STATUS;
  }
};
