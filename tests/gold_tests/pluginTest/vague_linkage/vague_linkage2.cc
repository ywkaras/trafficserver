...
TSPluginInit(int argc, const char *argv[])
{
  ...
  ALWAYS_ASSERT(vague_linkage::dflt == 1);
  ALWAYS_ASSERT(vague_linkage::inited == 2);
  ALWAYS_ASSERT(vague_linkage::dflt_f() == 1);
  ALWAYS_ASSERT(vague_linkage::inited_f() == 2);
