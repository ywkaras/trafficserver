...
class Txn:
    ...
    # duplicate_of - If not None, must be the string id of the transaction this one will be a duplicate of.  If
    #                req_mime_fields is None, it defaults to req_mime_fields of the duplicate transaction. The
    #                parameters unserver_resp_lines, userver_resp_body and use_userver_host are don't-cares.
