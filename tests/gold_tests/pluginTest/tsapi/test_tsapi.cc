...
// argv[3] - 2nd TCP port for testing.
// argv[4] - Pathspec of file to delete when all activity triggered by ports ready lifecycle hook completes.
//
void
TSPluginInit(int argc, const char *argv[])
{
  ...
  std::istringstream(argv[3]) >> test_tcp_port2;
