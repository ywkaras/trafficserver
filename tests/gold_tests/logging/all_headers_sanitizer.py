...
# This handles somes weird inconsisteny in the Etag value.  My best guess is that it's caused by different revisions of the
# standard Python http.server.HTTPServer class.
#
