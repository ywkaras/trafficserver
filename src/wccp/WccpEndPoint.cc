...
Impl::handleMessage()
{
  ...
  if (PARSE_SUCCESS == header.parse(msg_buffer)) {
    ...
    ts::TextView chunk(buffer, static_cast<std::size_t>(n));
...
ts::Errata
Impl::handleHereIAm(IpHeader const &, ts::TextView const &)
{
  return log(LVL_INFO, "Unanticipated WCCP2_HERE_I_AM message ignored");
}
ts::Errata
Impl::handleISeeYou(IpHeader const &, ts::TextView const &)
{
  return log(LVL_INFO, "Unanticipated WCCP2_I_SEE_YOU message ignored.");
}
ts::Errata
Impl::handleRedirectAssign(IpHeader const &, ts::TextView const &)
{
  return log(LVL_INFO, "Unanticipated WCCP2_REDIRECT_ASSIGN message ignored.");
}
ts::Errata
Impl::handleRemovalQuery(IpHeader const &, ts::TextView const &)
{
...
ts::Errata
CacheImpl::handleISeeYou(IpHeader const &, ts::TextView const &chunk)
{
  ts::Errata zret;
  ISeeYouMsg msg;
...
ts::Errata
CacheImpl::handleRemovalQuery(IpHeader const &, ts::TextView const &chunk)
{
  ts::Errata zret;
  RemovalQueryMsg msg;
  time_t now = time(0);
...
ts::Errata
RouterImpl::handleHereIAm(IpHeader const &ip_hdr, ts::TextView const &chunk)
{
  ts::Errata zret;
  HereIAmMsg msg;
