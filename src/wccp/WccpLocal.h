...
*/
class MsgBuffer : protected ts::TextView
{
public:
  typedef MsgBuffer self;     ///< Self reference type.
  typedef ts::TextView super; ///< Parent type.
...
public:
  ...
  */
  ...
  int parse(ts::TextView const &buffer ///< Raw message data.
  );
...
public:
  ...
  */
  ...
  virtual ts::Errata handleHereIAm(IpHeader const &header,  ///< IP packet data.
                                   ts::TextView const &data ///< Buffer with message data.
  );
...
protected:
  ...
  /// Process REMOVAL_QUERY message.
  virtual ts::Errata handleRemovalQuery(IpHeader const &header,  ///< IP packet data.
                                        ts::TextView const &data ///< Message data.
  );
