...
:cpp:func:`TSHttpTxnIsInternal`). These transactions are not initiated by
...
(via :cpp:func:`TSHttpTxnDebugSet`), which causes debug messages to be printed to
