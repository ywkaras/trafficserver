...
In this case the proxy request is available in the :cpp:enumerator:`TS_HTTP_TXN_START_HOOK` hook. This
...
:cpp:enumerator:`TS_HTTP_TXN_START_HOOK` and :cpp:enumerator:`TS_HTTP_TXN_CLOSE_HOOK`. In addition, because |TS|
