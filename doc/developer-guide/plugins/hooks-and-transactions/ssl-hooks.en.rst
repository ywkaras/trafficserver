...
In addition to the HTTP oriented hooks, a plugin can add hooks (by calling :cpp:func:`TSHttpHookAdd`)
...
The following actions are valid from these callbacks.
  ...
  * Fetch the SSL object associated with the connection - :cpp:func:`TSVConnSslConnectionGet`
  * Set a connection to blind tunnel - :cpp:func:`TSVConnTunnel`
  * Re-enable the ssl connection - :cpp:func:`TSVConnReenable`
  * Find SSL context by name - :cpp:func:`TSSslContextFindByName`
  * Find SSL context by address - :cpp:func:`TSSslContextFindByAddr`
  * Determine whether the TSVConn is really representing a SSL connection - :cpp:func:`TSVConnIsSsl`
...
The TLS handshake processing will not proceed until :cpp:func:`TSVConnReenable()` is called either
...
TLS handshake processing will pause until the hook callback executes :cpp:func:`TSVConnReenable()`.
...
:cpp:func:`TSVConnReenable()` since the OpenSSL implementation does not allow for pausing processing
...
will continue after the certificate hook callback execute by calling :cpp:func:`TSVConnReenable()` or
not.  The TLS handshake processing will not proceed until :cpp:func:`TSVConnReenable()` is called.
...
object using the :cpp:func:`TSVConnSslVerifyCTXGet()` method and fetch the peer's certificates to make
any additional checks.

Processing will continue regardless of whether the hook callback executes
:cpp:func:`TSVConnReenable()` since the OpenSSL implementation does not allow for pausing processing
during the certificate verify callback.  The plugin can use the :cpp:func:`TSVConnReenableEx()`
...
the :cpp:func:`TSVConnSslVerifyCTXGet()` method and fetch the peer's certificates to make any
additional checks.
