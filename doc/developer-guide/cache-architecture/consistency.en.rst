...
API calls :cpp:func:`TSHttpTxnCacheLookupUrlSet()` or  :c:func:`TSCacheUrlSet()`
...
If :cpp:func:`TSHttpTxnCacheLookupUrlGet()` is called after new cache url set by
:cpp:func:`TSHttpTxnCacheLookupUrlSet()` or :c:func:`TSCacheUrlSet()`, it should
use a URL location created by :cpp:func:`TSUrlCreate()` as its third input
