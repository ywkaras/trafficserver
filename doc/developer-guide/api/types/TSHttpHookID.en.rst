...
.. cpp:enum:: TSHttpHookID
   ...
   .. cpp:enumerator:: TS_HTTP_RESPONSE_CLIENT_HOOK

   .. cpp:enumerator:: TS_HTTP_REQUEST_CLIENT_HOOK

   .. cpp:enumerator:: TS_SSL_FIRST_HOOK

   .. cpp:enumerator:: TS_VCONN_START_HOOK

   .. cpp:enumerator:: TS_VCONN_OUTBOUND_START_HOOK

   .. cpp:enumerator:: TS_VCONN_CLOSE_HOOK

   .. cpp:enumerator:: TS_VCONN_OUTBOUND_CLOSE_HOOK
   ...
   .. cpp:enumerator:: TS_SSL_VERIFY_CLIENT_HOOK

   .. cpp:enumerator:: TS_SSL_VERIFY_SERVER_HOOK

   .. cpp:enumerator:: TS_SSL_LAST_HOOK

   .. cpp:enumerator:: TS_HTTP_LAST_HOOK

Description
===========

Note that :cpp:enumerator:`TS_SSL_CERT_HOOK` and :cpp:enumerator:`TS_SSL_SNI_HOOK` correspond to the same OpenSSL
callbacks. This is done for backwards compatibility. :cpp:enumerator:`TS_SSL_SNI_HOOK` is expected
to be deprecated and removed, plugins using this should change to :cpp:enumerator:`TS_SSL_CERT_HOOK` or
:cpp:enumerator:`TS_SSL_SERVERNAME_HOOK` as appropriate.

.. warning:: OpenSSL 1.0.2 and later versions

   :cpp:enumerator:`TS_SSL_SERVERNAME_HOOK` is invoked for the OpenSSL servername callback.
   :cpp:enumerator:`TS_SSL_SNI_HOOK` and :cpp:enumerator:`TS_SSL_CERT_HOOK` are invoked for the OpenSSL certificate
   ...
   :cpp:enumerator:`TS_SSL_SERVERNAME_HOOK` to get called back for all TLS transaction and
   :cpp:enumerator:`TS_SSL_CERT_HOOK` to get called back only to select a certificate.
