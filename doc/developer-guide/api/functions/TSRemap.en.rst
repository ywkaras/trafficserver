...
by passing :cpp:enumerator:`TSREMAP_CONFIG_RELOAD_FAILURE` in case of failure and to notify the plugins if they
are going to be part of the new configuration by passing :cpp:enumerator:`TSREMAP_CONFIG_RELOAD_SUCCESS_PLUGIN_USED`
or :cpp:enumerator:`TSREMAP_CONFIG_RELOAD_SUCCESS_PLUGIN_UNUSED`. This is an optional entry point.
...
transaction was modified, the plugin should return :cpp:enumerator:`TSREMAP_DID_REMAP` or
:cpp:enumerator:`TSREMAP_DID_REMAP_STOP`; otherwise it should return :cpp:enumerator:`TSREMAP_NO_REMAP` or
:cpp:enumerator:`TSREMAP_NO_REMAP_STOP`. If Traffic Server should not send the transaction to subsequent
plugins in the remap chain, return :cpp:enumerator:`TSREMAP_NO_REMAP_STOP` or :cpp:enumerator:`TSREMAP_DID_REMAP_STOP`.
Returning :cpp:enumerator:`TSREMAP_ERROR` causes Traffic Server to stop evaluating the remap chain and respond
with an error.
