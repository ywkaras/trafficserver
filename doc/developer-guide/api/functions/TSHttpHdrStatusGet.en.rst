...
plugins can call :cpp:func:`TSHttpHdrStatusSet` this may not be true. If the header is not a valid
response then :cpp:enumerator:`TS_HTTP_STATUS_NONE` is returned.

See Also
========

:cpp:func:`TSHttpTxnClientRespGet`, :cpp:func:`TSHttpTxnServerRespGet`, :cpp:func:`TSHttpHdrTypeGet`.
