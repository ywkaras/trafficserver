...
:cpp:func:`TSRPCRegisterMethodHandler` Add new registered method handler to the JSON RPC engine.
...
:arg:`callback` The function to be registered. Check :cpp:type:`TSRPCMethodCb`.
...
:cpp:func:`TSRPCRegisterNotificationHandler` Add new registered method handler to the JSON RPC engine.
...
:arg:`callback` The function to be registered. Check :cpp:type:`TSRPCNotificationCb`.
...
:cpp:func:`TSRPCHandlerDone` Function to notify the JSONRPC engine that the plugin handler is finished processing the current request.
...
:cpp:func:`TSRPCHandlerError` Function to notify the JSONRPC engine that the plugin handler is finished processing the current request with an error.
...
.. important::
    ...
    You must always inform the RPC after processing the jsonrpc request. Either by calling :cpp:func:`TSRPCHandlerDone` or :cpp:func:`TSRPCHandlerError`
    . Calling either of these functions twice is a serious error. You should call exactly one of these functions.

Return Values
=============

:cpp:func:`TSRPCRegister` returns :enumerator:`TS_SUCCESS` if all is good, :enumerator:`TS_ERROR` if the :arg:`yamlcpp_lib_version`
was not set, or the ``yamlcpp`` version does not match with the one used internally in TS.

:cpp:func:`TSRPCRegisterMethodHandler` :enumerator:`TS_SUCCESS` if the handler was successfully registered, :enumerator:`TS_ERROR` if the handler is already registered.

:cpp:func:`TSRPCRegisterNotificationHandler`:enumerator:`TS_SUCCESS` if the handler was successfully registered, :enumerator:`TS_ERROR` if the handler is already registered.

:cpp:func:`TSRPCHandlerDone` Returns :enumerator:`TS_SUCCESS` if no issues, or  :enumerator:`TS_ERROR` if an issue was found.

:cpp:func:`TSRPCHandlerError` Returns :enumerator:`TS_SUCCESS` if no issues, or  :enumerator:`TS_ERROR` if an issue was found.
