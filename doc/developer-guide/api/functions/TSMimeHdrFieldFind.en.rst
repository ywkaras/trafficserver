...
:cpp:func:`TSMimeHdrFieldFind` cannot find the requested field, it
returns :var:`TS_NULL_MLOC`.  Release the returned :cpp:type:`TSMLoc`
handle with a call to :cpp:func:`TSHandleMLocRelease`.
...
can also be looked up using :cpp:func:`TSMimeHdrStringToWKS`. If a header does
