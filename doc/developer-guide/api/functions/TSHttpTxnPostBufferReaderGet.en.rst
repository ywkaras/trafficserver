...
via :cpp:func:`TSIOBufferReaderFree`. This function should be used in the handler
for :cpp:enumerator:`TS_HTTP_REQUEST_BUFFER_READ_COMPLETE_HOOK`. The following example
handler makes use of :cpp:func:`TSHttpTxnPostBufferReaderGet`.
