...
This info is available at or after the :cpp:enumerator:`TS_HTTP_POST_REMAP_HOOK` hook.  If the function returns
:cpp:enumerator:`TS_SUCCESS`, the location of the URL is put into the variable pointed to by :arg:`urlLocp`.  On error, the function
returns :cpp:enumerator:`TS_ERROR`.
