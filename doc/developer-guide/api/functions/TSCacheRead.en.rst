...
:arg:`contp` back with the event :cpp:enumerator:`TS_EVENT_CACHE_OPEN_READ`. In this case,
...
:cpp:enumerator:`TS_EVENT_CACHE_OPEN_READ_FAILED`. The user (:arg:`contp`) has the option to
cancel the action returned by :c:func:`TSCacheRead`. Note that reentrant calls
