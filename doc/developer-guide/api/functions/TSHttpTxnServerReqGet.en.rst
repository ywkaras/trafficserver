...
This call returns :cpp:enumerator:`TS_SUCCESS` on success, and :cpp:enumerator:`TS_ERROR` on failure. It is the
...
:cpp:enumerator:`TS_HTTP_SEND_REQUEST_HDR_HOOK`). Note that for earlier hooks, the request may not yet
