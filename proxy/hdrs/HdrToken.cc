...
// WARNING:  Indexes into this array are stored on disk for cached objects.  New strings must be added at the end of this array
// to avoid changing the indexes of pre-existing entries, unless the cache format version number is increased.
//
